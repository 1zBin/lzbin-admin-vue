  ...
  <simple-page :current="current">
    <a-card>
      <a-tabs v-model:activeKey="activeKey" @change="tabChange(activeKey)">
        <a-tab-pane key="route" tab="添加路由" force-render
          ><AddRoute
            ref="addRouteRef"
            :popId="popId"
...
import AddRoute from "./components/route/add-route.vue";
...
const addRouteRef = ref<ConfigRef | null>(null);
...
const currentData: CurrentData = {
  route: {
    name: "route",
    title: "添加路由",
    path: "/device-management/pop-dev/add-route/:_",
    isBlack: true,
