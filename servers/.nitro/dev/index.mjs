...
import { provider, isWindows } from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, setResponseHeader, send, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, createError, getRouterParam, getQuery as getQuery$1, readBody, getHeader } from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/h3/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/ofetch/dist/node.mjs';
import destr from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/radix3/dist/index.mjs';
import dayjs from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/dayjs/dayjs.min.js';
import { cloneDeep } from 'file://F:/%E8%AF%BE%E4%BB%B6/lzbin-admin-vue/node_modules/lodash-es/lodash.js';
...
const serverAssets = [{"baseName":"server","dir":"F:/课件/lzbin-admin-vue/servers/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"F:\\课件\\lzbin-admin-vue","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"F:\\课件\\lzbin-admin-vue\\servers","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"F:\\课件\\lzbin-admin-vue\\servers\\.nitro","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"F:\\课件\\lzbin-admin-vue\\servers\\.nitro\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"F:\\课件\\lzbin-admin-vue\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_ldRE3T = () => Promise.resolve().then(function () { return _401$1; });
const _lazy_Us9GpK = () => Promise.resolve().then(function () { return _403$1; });
const _lazy_cSGDJ3 = () => Promise.resolve().then(function () { return _500$1; });
const _lazy_IslEXh = () => Promise.resolve().then(function () { return index$3; });
const _lazy_tsWuZv = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_PVzalI = () => Promise.resolve().then(function () { return basicList_post$1; });
const _lazy_07nKGr = () => Promise.resolve().then(function () { return consultList_post$1; });
const _lazy_ym6KFa = () => Promise.resolve().then(function () { return create_post$1; });
const _lazy_rLPDGr = () => Promise.resolve().then(function () { return crudTable_post$1; });
const _lazy_XUdaAw = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_pcukPd = () => Promise.resolve().then(function () { return index_put$1; });
const _lazy_5XBebs = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_eRbjuM = () => Promise.resolve().then(function () { return logout$1; });
const _lazy_8LIPoA = () => Promise.resolve().then(function () { return index$1; });
const _lazy_BNa8aj = () => Promise.resolve().then(function () { return test_delete$1; });
const _lazy_E99jN8 = () => Promise.resolve().then(function () { return test_post$1; });
const _lazy_ZvtxLV = () => Promise.resolve().then(function () { return test_put$1; });
const _lazy_HmSAWy = () => Promise.resolve().then(function () { return info$1; });

const handlers = [
  { route: '/401', handler: _lazy_ldRE3T, lazy: true, middleware: false, method: undefined },
  { route: '/403', handler: _lazy_Us9GpK, lazy: true, middleware: false, method: undefined },
  { route: '/500', handler: _lazy_cSGDJ3, lazy: true, middleware: false, method: undefined },
  { route: '/', handler: _lazy_IslEXh, lazy: true, middleware: false, method: undefined },
  { route: '/list/:id', handler: _lazy_tsWuZv, lazy: true, middleware: false, method: "delete" },
  { route: '/list/basic-list', handler: _lazy_PVzalI, lazy: true, middleware: false, method: "post" },
  { route: '/list/consult-list', handler: _lazy_07nKGr, lazy: true, middleware: false, method: "post" },
  { route: '/list/create', handler: _lazy_ym6KFa, lazy: true, middleware: false, method: "post" },
  { route: '/list/crud-table', handler: _lazy_rLPDGr, lazy: true, middleware: false, method: "post" },
  { route: '/list', handler: _lazy_XUdaAw, lazy: true, middleware: false, method: "post" },
  { route: '/list', handler: _lazy_pcukPd, lazy: true, middleware: false, method: "put" },
  { route: '/login', handler: _lazy_5XBebs, lazy: true, middleware: false, method: "post" },
  { route: '/logout', handler: _lazy_eRbjuM, lazy: true, middleware: false, method: undefined },
  { route: '/menu', handler: _lazy_8LIPoA, lazy: true, middleware: false, method: undefined },
  { route: '/test', handler: _lazy_BNa8aj, lazy: true, middleware: false, method: "delete" },
  { route: '/test', handler: _lazy_E99jN8, lazy: true, middleware: false, method: "post" },
  { route: '/test', handler: _lazy_ZvtxLV, lazy: true, middleware: false, method: "put" },
  { route: '/user/info', handler: _lazy_HmSAWy, lazy: true, middleware: false, method: undefined }
];
